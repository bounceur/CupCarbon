...
public class VisibilityZones3 extends Thread {	
	...
	// Constructor
	//-----------------------------------------------------------------------------------------
	public VisibilityZones3(SensorNode sensorNode) {
	...
	public void run() {
		...
		//-----------------------------------------------------------------------------------------
		// Assign the values of the visibliity zone that are the same values of the list:
		// visibilityPointList
		//-----------------------------------------------------------------------------------------
		int k = 0;
