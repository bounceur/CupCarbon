...
final public class Edge_traited implements Comparable<Edge_traited>, Serializable {
     ...
     */
    public Edge_traited(Vector3d A, Vector3d B, Face f) {
    ...
    public int compareTo (Edge_traited e) {
    ...
    /**
     * convert Egde to Edge_traited
     */

    public static Edge_traited Edge2Edge_traited(Edge edge) {
        Edge_traited Edge_t = new Edge_traited(edge.getA(),edge.getB(),edge.getFace());
        Edge_t.traited=0;
        return Edge_t;
    }
