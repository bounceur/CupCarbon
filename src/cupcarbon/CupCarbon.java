...
import battery.BatteryModelWindow;
...
public class CupCarbon {
	...
	// ------------------------------------------------------------------------------------------KADJOUH
	private BatteryModelWindow batModelWindow = new BatteryModelWindow();
	// ------------------------------------------------------------------------------------------KADJOUH
	...
	// private FlyingObjParametersWindow flyingObjParametersWindow = new
	// FlyingObjParametersWindow();
	...
	// ------------------------------------------------------------------------------------------KADJOUH
	public static JLabel lblTemperature = new JLabel(" | °C");
	// ------------------------------------------------------------------------------------------KADJOUH
	...
	private void initialize() {
		...
		mnProject.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "projects_folder_badged.png"));
		menuBar.add(mnProject);
		mainFrame.addWindowListener(new WindowListener() {
			@Override
			public void windowClosing(WindowEvent arg0) {
				int n = JOptionPane.showConfirmDialog(mainFrame, "Would you like to quit ?", "Quit",
		...
		mntmNewProject.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (val == 0) {
					Project.newProject(
							fc.getSelectedFile().getParent() + File.separator + fc.getSelectedFile().getName(),
		...
		mntmReset.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int n = JOptionPane.showConfirmDialog(mainFrame, "Would you like to reset?", "Reset",
						JOptionPane.YES_NO_OPTION);
				if (n == 0) {
		...
		mnEdition.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "blockdevice.png"));
		...
		mntmNewMenuItem_2.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "arrow_rotate_clockwise.png"));
		...
		mntmRetry.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "arrow_rotate_anticlockwise.png"));
		...
		mnSelection.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "shape_square_select.png"));
		...
		mntmSelectAll.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "shapes_many_select.png"));
		...
		mntmDeselectAll.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "selection.png"));
		...
		mntmInvertSelection.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "stock_filters_invert.png"));
		...
		chckbxmntmAddSelection.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "layer_select.png"));
		...
		mntmSelectAllSensors.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				WorldMap.setSelectionOfAllNodes(true, Device.SENSOR, chckbxmntmAddSelection.getState());
			}
		});
		mntmSelectAllSensors.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "select_node.png"));
		...
		mntmSelectAllGasses.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				WorldMap.setSelectionOfAllNodes(true, Device.GAS, chckbxmntmAddSelection.getState());
			}
		});
		mntmSelectAllGasses.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "select_node.png"));
		...
		mntmSelectAllMobiles.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				WorldMap.setSelectionOfAllNodes(true, Device.MOBILE, chckbxmntmAddSelection.getState());
			}
		});
		mntmSelectAllMobiles.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "select_node.png"));

		JMenuItem mntmSelectAllMobiles_1 = new JMenuItem("Select All Mobiles WR");
		mnSelectAll.add(mntmSelectAllMobiles_1);
		mntmSelectAllMobiles_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				WorldMap.setSelectionOfAllNodes(true, Device.MOBILE_WR, chckbxmntmAddSelection.getState());
			}
		});
		mntmSelectAllMobiles_1.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "select_node.png"));
		...
		mntmSelectAllRouters.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				WorldMap.setSelectionOfAllNodes(true, Device.MEDIA_SENSOR, chckbxmntmAddSelection.getState());
			}
		});
		mntmSelectAllRouters.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "select_node.png"));
		...
		mntmSelectAllFlyingObjects.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				WorldMap.setSelectionOfAllNodes(true, Device.FLYING_OBJECT, chckbxmntmAddSelection.getState());
			}
		});
		mntmSelectAllFlyingObjects.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "select_node.png"));
		...
		mntmSelectAllBase.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				WorldMap.setSelectionOfAllNodes(true, Device.BASE_STATION, chckbxmntmAddSelection.getState());
			}
		});
		mntmSelectAllBase.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "select_node.png"));
		...
		mntmSelectAllMarkers.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				WorldMap.setSelectionOfAllMarkers(true, Device.MARKER, chckbxmntmAddSelection.getState());
			}
		});
		mntmSelectAllMarkers.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "select_node.png"));
		...
		mntmDeselectAllSensors.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "deselect_node.png"));
		...
		mntmDeselectAllGasses.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "deselect_node.png"));
		...
		mntmDeselectAllMobiles.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "deselect_node.png"));

		JMenuItem mntmDeselectAllMobiles_1 = new JMenuItem("Deselect All Mobiles WR");
		...
		mntmDeselectAllMobiles_1.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "deselect_node.png"));
		...
		mntmDeselectAllRouters.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "deselect_node.png"));
		...
		mntmDeselectAllFlyingObjects.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "deselect_node.png"));

		JMenuItem mntmDeselectAllBase = new JMenuItem("Deselect All Base Stations");
		...
		mntmDeselectAllBase.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "deselect_node.png"));
		...
		mntmDeselectAllMarkers.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "deselect_node.png"));

		JSeparator separator_9 = new JSeparator();
		mnSelection.add(separator_9);

		JMenu mnNodes = new JMenu("Nodes");
		mnNodes.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "blank_badge_green.png"));
		menuBar.add(mnNodes);
		...
		mntmLoadBuildings.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "building.png"));
		mnNodes.add(mntmLoadBuildings);

		JSeparator separator_5 = new JSeparator();
		mnNodes.add(separator_5);
		mntmAddSensor.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "blank_badge_mauve.png"));
		mnNodes.add(mntmAddSensor);

		JMenuItem mntmAddBaseStation = new JMenuItem("Add Base Station");
		mntmAddBaseStation.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "blank_badge_orange.png"));
		mnNodes.add(mntmAddBaseStation);

		JMenuItem mntmAddGas = new JMenuItem("Add Gas");
		mntmAddGas.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "circle_orange.png"));
		mnNodes.add(mntmAddGas);

		JMenuItem mntmAddMobile = new JMenuItem("Add Mobile");
		mntmAddMobile.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "blank_badge_noir.png"));
		mnNodes.add(mntmAddMobile);

		JMenuItem mntmAddFlyingObjects = new JMenuItem("Add Flying Objects");
		mntmAddFlyingObjects.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "insects.png"));
		mnNodes.add(mntmAddFlyingObjects);

		JMenuItem mntmAddMarkers = new JMenuItem("Add Markers");
		mntmAddMarkers.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "marker_rounded_light_blue.png"));
		mnNodes.add(mntmAddMarkers);

		JMenu mnRandom = new JMenu("Random");
		mnRandom.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "randomp.png"));
		...
		JMenuItem mntmMarkerParameters = new JMenuItem("Marker Parameters");
		...
		mntmMarkerParameters.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "ui_menu_blue.png"));
		mnNodes.add(mntmMarkerParameters);
		mntmRouteFromMarkers.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "route.png"));
		...
		mntmInsertMarker.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "route2.png"));
		...
		mntmTransformMarkerTo.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "marktosens.png"));
		...
		// mntmToOmnet
		// .setIcon(new ImageIcon(CupCarbonParameters.IMGPATH +
		// "loopnone-1.png"));
		...
		mntmInitialize_1.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "circle_grey.png"));
		...
		mntmInitializeAll.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "circle_grey.png"));
		...
		mntmSensorGraph.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "graph.png"));
		mntmSensorGraph.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				infoWindow.toFront();
				infoWindow.getTextPane().setText(DeviceList.displaySensorGraph().toString());
			}
		});
		...
		mntmSensortargetGraph.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				infoWindow.toFront();
				infoWindow.getTextPane().setText(DeviceList.displaySensorTargetGraph().toString());
			}
		});
		mntmSensortargetGraph.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "graph.png"));
		mnGraph.add(mntmSensortargetGraph);

		JMenu mnResolution = new JMenu("Solver");
		mnResolution.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "edu_mathematics-1.png"));
		menuBar.add(mnResolution);

		JMenuItem mntmMinSetCover = new JMenuItem("Sensor Coverage");
		mntmMinSetCover.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "edu_mathematics-1.png"));
		...
		mntmNewMenuItem.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "edu_mathematics-1.png"));
		mnResolution.add(mntmNewMenuItem);

		JMenuItem mntmTargetCoverageth = new JMenuItem("Target Coverage (Th)");
		mntmTargetCoverageth.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "edu_mathematics-1.png"));
		...
		mntmScheduling.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "edu_mathematics-1.png"));
		...
		// mntmGpsrb.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH +
		...
		// mntmEnvelopeAngle.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH +
		// "edu_mathematics-1.png"));
		...
		mntmSimulate.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "flag_green.png"));
		...
		mntmStopSimulation.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "flag_red.png"));
		...
		mntmInitialize.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "circle_grey.png"));
		...
		//
		// JMenuItem mntmSimulateTrackingreal = new JMenuItem("Simulate Tracking
		// (real)");
		...
		//
		// JMenuItem mntmSimulateTrackingKhaoula = new JMenuItem("Simulate
		// Tracking Khaoula");
		...
		mntmStopFaultInjector.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "stopinjection.png"));
		...
		JMenuItem mntmGenWeatherFile = new JMenuItem("Random generate weather file");
		mntmGenWeatherFile.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R, Event.ALT_MASK));
		mntmGenWeatherFile.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "genWeather.png"));
		mnSimulation.add(mntmGenWeatherFile);

		mntmGenWeatherFile.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {

				if (FileManager.pathExists(Project.projectPath)) {
					weather.GenerateWeather.generate();
				} else
					JOptionPane.showMessageDialog(null, "Create project first !", "Cup Crabon",
							JOptionPane.WARNING_MESSAGE);
			}
		});

		JMenuItem mntmWeather_events = new JMenuItem("Import weather file");
		mntmWeather_events.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_I, Event.ALT_MASK));
		mntmWeather_events.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "weather.png"));
		mnSimulation.add(mntmWeather_events);

		mntmWeather_events.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Frame fr = null;
				String s = LoadFromFile(fr);
				if (s != "") {

					/////// Reading File In the list
					List<String> l;
					l = weather.FileManager.FileRead(s);
					/////// Writing the file from list

					s = Project.getProjectWeather_eventsPath() + File.separator + "WeatherFile.wsc";
					weather.FileManager.FileWrite(s, l);

					Project.setProjectWeather_eventsFileName(s);

				} else {
					JOptionPane.showMessageDialog(null,
							"Reading File error" + Project.getProjectWeather_eventsFileName(), "CupCarbon",
							JOptionPane.INFORMATION_MESSAGE);
				}
			}

			public String LoadFromFile(Frame fr) {
				FileDialog fileDialog = new FileDialog(fr, "Load weather events file", FileDialog.LOAD);
				// fileDialog.setFile(Project.get);
				fileDialog.setDirectory(Project.getProjectWeather_eventsPath());
				fileDialog.setLocation(50, 50);
				// fileDialog.setFilenameFilter(Project.getWeather_eventsFileExtension());
				fileDialog.setVisible(true);
				return fileDialog.getDirectory() + fileDialog.getFile();
			}
		});

		JMenuItem mntmBatteryModel = new JMenuItem("Battery model");
		mntmBatteryModel.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_B, Event.ALT_MASK));
		mntmBatteryModel.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "battery.png"));
		mnSimulation.add(mntmBatteryModel);

		mntmBatteryModel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				File bmFiles = new File(Project.getProjectBatteryModelPath());
				String[] c = bmFiles.list();
				BatteryModelWindow.txtLoadFileName.removeAllItems();
				BatteryModelWindow.txtLoadFileName.addItem("New battery model ...");
				for (int i = 0; i < c.length; i++) {
					BatteryModelWindow.txtLoadFileName.addItem(c[i]);
				}

				if (!batModelWindow.isVisible()) {
					desktopPane.add(batModelWindow);
					batModelWindow.setVisible(true);
				}
				batModelWindow.toFront();
			}
		});
		...
		mntmCreateComScenario.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "stylo.png"));
		...
		mntmSimulation.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "settings_right_rest.png"));
		...
		mnPerso.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "personal-icon.png"));
		menuBar.add(mnPerso);
		...
		mntmAboutCupcarbon.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "symbol_information.png"));
		...
		btnSensor.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "blank_badge_mauve.png"));
		...
		btnMobile.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "blank_badge_noir.png"));
		...
		btnBaseStation.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "blank_badge_orange.png"));
		...
		btnMarker.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "marker_rounded_light_blue.png"));
		...
		btnVisibility.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// "+BuildingList.size());
				// Vi_VisibilityLauncher vl = new Vi_VisibilityLauncher();
				// vl.start();
			}
		});
		...
		button.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "square_red.png"));
		...
		// panel_2.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null,
		// null));
		panel_1.add(panel_2);
	...
	private void openDeviceParemeterWindow() {
		...
		//------------------------------------------------------------------------------------------KADJOUH	 		
				File batteryModelFiles = new File(Project.getProjectBatteryModelPath());
				String[] s1 = batteryModelFiles.list();
				if (s1 == null)
					s1 = new String[1];
				DeviceParametersWindow.batteryModelComboBox.removeAllItems();
				DeviceParametersWindow.batteryModelComboBox.addItem("");
				for (int i = 0; i < s1.length; i++) {
					DeviceParametersWindow.batteryModelComboBox.addItem(s1[i]);
				}
		//------------------------------------------------------------------------------------------KADJOUH	 	
