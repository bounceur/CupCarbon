 ...
 * @version 1.0
 */
public class AnalogEvent extends DeviceWithoutRadio {
	...
	public AnalogEvent(double x, double y, double radius, int id) {
		super(x, y, radius, id);
		random = new Random();
	}
	
	public AnalogEvent(String x, String y, String radius, int id) {
