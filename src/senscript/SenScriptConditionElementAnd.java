...
public class ConditionElementAnd extends ConditionElement{
	...
	public ConditionElementAnd(SensorNode sensor, ConditionElement conditionL, ConditionElement conditionR){
