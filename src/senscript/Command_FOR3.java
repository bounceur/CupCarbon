...
public class Command_FOR3 extends Command {
	...
	protected Command_FOR3 parent = null;
	...
	public Command_FOR3 getParent() {
		return parent;
	}

	public void setParent(Command_FOR3 parent) {
		this.parent = parent;
	}

	public Command_FOR3(SensorNode sensor, String arg1, String arg2, String arg3, String arg4) {
		// for i 0 10 1
		this.sensor = sensor ; 	
